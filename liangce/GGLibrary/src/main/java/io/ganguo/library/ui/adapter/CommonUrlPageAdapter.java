 ...
 */
public class CommonUrlPageAdapter extends PagerAdapter implements IListAdapter<View> {
    private static final String TAG = CommonUrlPageAdapter.class.getName();
    private List<View> mViews;

    public CommonUrlPageAdapter() {

    }

    public CommonUrlPageAdapter(List<View> views) {
        mViews = views;
    }
