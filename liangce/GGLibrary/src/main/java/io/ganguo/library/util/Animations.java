...
public class Animations {
     ...
     * 获取一个向上翻转动画
     *
     * @return 向上翻转180度，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    public static RotateAnimation getRotateUpAnimation() {
        RotateAnimation anim = getRotateAnimation(0, 180, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF, 0.5f, DEFAULT_ANIMATION_DURATION, null);
     ...
     * 获取一个向下翻转动画
     *
     * @return 向下翻转180度，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    public static RotateAnimation getRotateDownAnimation() {
        RotateAnimation anim = getRotateAnimation(180, 0, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF, 0.5f, DEFAULT_ANIMATION_DURATION, null);
        anim.setFillAfter(true);
        return anim;
    }
