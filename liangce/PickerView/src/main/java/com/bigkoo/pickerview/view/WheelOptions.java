...
//		// 添加联动监听
    ...
    public void setCurrentItems(int option1, int option2, int option3) {
        ...
        if (mOptions1Items != null && option1 < mOptions1Items.size()) {
            wv_option1.setCurrentItem(option1);
        }
        if (mOptions2Items != null && option2 < mOptions2Items.size()) {
            wv_option2.setCurrentItem(option2);
        }
        if (mOptions3Items != null && option3 < mOptions3Items.size()) {
